...
> ⚠️ **Archived.** This page describes the early task/operator protocol design, which was superseded by the implemented gRPC protocol described in [Protocol](/protocol). It is kept for historical context.
